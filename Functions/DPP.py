...
class DetectClean:
    ...
    def find_to_clean(self, df, unique, info_percent=0.95):
        self.df = df
        ...
        print(str(self.int_col)+"= int_col")
        print(str(self.cate_col)+"= cate_col")
        print(str(self.int_missing)+"= int_missing")
        print(str(self.outliers)+"= outliers")
        print(str(self.low_information_cols)+"= low_information_cols")
        print(str(self.drop_list)+"= drop_list")
